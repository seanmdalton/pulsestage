    ...
    <div className="max-w-4xl mx-auto">
      ...
      {questions.length === 0 ? (
        <div className="text-center py-12">
          <div className="text-gray-500 dark:text-gray-400 mb-2">📝 No answered questions yet</div>
          <div className="text-sm text-gray-400 dark:text-gray-500">Questions will appear here once they're answered.</div>
        </div>
      ) : (
                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <span>{question.respondedAt ? new Date(question.respondedAt).toLocaleDateString() : new Date(question.createdAt).toLocaleDateString()}</span>
                      </div>
                    ...
                    <div className="border-t border-gray-100 dark:border-gray-700 pt-3">
                      <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Answer</h4>
