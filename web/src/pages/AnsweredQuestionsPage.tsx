...
export function AnsweredQuestionsPage() {
  ...
  if (loading) {
    return (
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Answered Questions</h1>
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {questions.length === 0 ? (
        <div className="text-center py-8">
          <div className="text-gray-500">No answered questions yet.</div>
        </div>
      ) : (
          ...
          {questions.map((question) => (
            ...
            >
              ...
              <div className="border-t pt-4">
                ...
                <p className="text-gray-700 whitespace-pre-wrap">{question.responseText}</p>
                <div className="text-sm text-gray-500 mt-2">
