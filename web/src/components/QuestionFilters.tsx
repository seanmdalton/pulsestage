...
export function QuestionFilters({
  ...
  return (
    <div className="relative flex-1">
      ...
      <div className="flex gap-2 items-center">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="block w-full pl-9 pr-3 py-2 border-0 bg-transparent text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-0 text-sm"
          />
          {search && (
            <button
              onClick={() => setSearch('')}
        ...
        <button
          ...
          className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center gap-2 text-sm flex-shrink-0"
        >
          <svg
            className="w-4 h-4"
            fill="none"
      ...
      {showAdvanced && (
        <div className="absolute top-full left-0 right-0 mt-2 z-10 grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-lg">
          {/* Tag Filter */}
          {tags.length > 0 && (
            <div>
